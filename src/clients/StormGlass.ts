...
export interface ForecastPoint{  // a estrutura dos dados normalizado do StormGlassForecastResponse
    time:string;
...
export class StormGlass{
    ...
    private isValidPoint(point:Partial<StormGlassPoint>):boolean{ // Basicamente, essa função vai garantir que todos os objetos passados possuem as chaves necessárias
        return !!( //o !! traz um reforço para que o retorno seja, de fato, boolean Ver essa parte caso precise reçembrar https://youtu.be/x4Llr0DwOaA?t=1000
            point.time &&
